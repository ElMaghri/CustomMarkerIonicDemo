...
var HomePage = (function () {
    function HomePage(googleMaps, platform) {
    ...
    HomePage.prototype.loadMap = function () {
        ...
        this.map.one(__WEBPACK_IMPORTED_MODULE_2__ionic_native_google_maps__["b" /* GoogleMapsEvent */].MAP_READY).then(function () {
            return _this.map
                ...
                .then(function (grnoudoverlay) {
                grnoudoverlay
                    .on(__WEBPACK_IMPORTED_MODULE_2__ionic_native_google_maps__["b" /* GoogleMapsEvent */].GROUND_OVERLAY_CLICK)
                    .subscribe(function () {
                    console.log("clicked");
                    grnoudoverlay.setImage("https://static.pexels.com/photos/20974/pexels-photo.jpg");
                });
            });
            // this.map
            //   .addMarker({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_google_maps__ = __webpack_require__(196);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
